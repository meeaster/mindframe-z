...
// The whole-output token a delta gather emits when nothing past the cursor serves the
// charter. One definition feeds the persona, the delta gather prompt, and ingest's

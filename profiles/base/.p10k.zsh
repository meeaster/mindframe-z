# Generated by Powerlevel10k configuration wizard on 2026-05-27 at 10:54 CDT.
...
() {
  ...
  # Avoid Powerlevel10k background zsh workers/FIFOs that can wedge WSL's PTY bridge after TUIs.
